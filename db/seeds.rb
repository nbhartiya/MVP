...
profile = Profile.find_or_create_by_user_id(:blurb => "ask me about the burroti", :location_id => nil, :story => nil, :home_zip => "94122", :work_zip => "94109", :user_id => 4, :biz_name => "Tava", :yelp_id => nil, :neighborhood => "SoMa")
profile = Profile.find_or_create_by_user_id(:blurb => "plenty of fish in the sea (and need to keep it that way!)", :location_id => nil, :story => nil, :home_zip => "94109", :work_zip => "94109", :user_id => 5, :biz_name => "Fish", :yelp_id => nil, :neighborhood => "Marina")
