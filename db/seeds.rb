...
profile = Profile.find_or_create_by_user_id(:blurb => "the only thing better than pie or ice cream is pie AND ice cream", :location_id => 1, :story => nil, :home_zip => "94109", :work_zip => "94109", :user_id => 3,  :biz_name => "Chile Pies and Creamery", :yelp_id => nil, :neighborhood => "NoPa")
...
profile = Profile.find_or_create_by_user_id(:blurb => "find peace in the middle of chaos", :location_id => 2, :story => nil, :home_zip => "94109", :work_zip => "94107", :user_id => 2, :biz_name => "Samovar Tea Lounge", :yelp_id => nil, :neighborhood => "SoMa")
profile = Profile.find_or_create_by_user_id(:blurb => "ask me about the burroti", :location_id => 3, :story => nil, :home_zip => "94122", :work_zip => "94109", :user_id => 4, :biz_name => "Tava", :yelp_id => nil, :neighborhood => "SoMa")
profile = Profile.find_or_create_by_user_id(:blurb => "plenty of fish in the sea (and need to keep it that way!)", :location_id => 4, :story => nil, :home_zip => "94109", :work_zip => "94109", :user_id => 5, :biz_name => "Fish", :yelp_id => nil, :neighborhood => "Marina")
