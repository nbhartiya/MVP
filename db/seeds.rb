...
user = User.find_or_initialize_by_email("neeharika.b+1@gmail.com") do |u|
	u.first_name = "Wendy"
	u.last_name = "Lin"
	u.password = "letsSimmr2"
	u.password_confirmation = "letsSimmr2"
	u.chef = false
	u.save
...
begin
  User.create!(:email => "abc@gmail.com", :password => "letsSimmr2", :password_confirmation => "letsSimmr2")
rescue => e
  puts "errors"+e.inspect
end 

email = "meow1@mestewie.rog"
...
user = User.find_or_create_by_email("neeharika.b+2@gmail.com") do |u|
	u.first_name = "Jesse"
	u.last_name = "Jacobs"
	u.password = "letsSimmr2"
	u.password_confirmation = "letsSimmr2"
...
user = User.find_or_create_by_email("neeharika.b+3@gmail.com") do |u|
	u.first_name = "Heather"
...
user = User.find_or_create_by_email("neeharika.b+4@gmail.com") do |u|
	u.first_name = "Vijay"
	u.last_name = "Brihmadesam"
	u.password = "letsSimmr2"
	u.password_confirmation = "letsSimmr2"
	u.chef = true
	u.save!
...
user = User.find_or_create_by_email("neeharika.b+5@gmail.com") do |u|
	u.first_name = "Doug"
	u.last_name = "Fisherman"
	u.password = "letsSimmr2"
	u.password_confirmation = "letsSimmr2"
	u.chef = true
	u.save!
...
user = User.find_or_create_by_email("neeharika.b@gmail.com") do |u|
	u.first_name = "Neeharika"
	u.last_name = "Bhartiya"
	u.password = "letsSimmr2"
	u.password_confirmation = "letsSimmr2"
	u.chef = false
	u.save!
...
campaign = Campaign.find_or_create_by_biz_name(:biz_name => "State Bird Provisions", :blurb => "James Beard best new restaurant (and the best meal I've ever had)!", :about => nil, :why_join => "Because it's obvious that State Bird Provisions is the best resaturant ever!", :location_id => 5, :campaign_starter_id => 1, :host_id => nil, :successful => false, :expires => "2013-07-30")
...
event = Event.find_or_create_by_title(:title => "Pie Shake Make", :people_limit => 35, :description => "Make pies with Chile Pies and Creamery", :menu_pdf => "http://www.nen.nl/pdfpreview/preview_68011.pdf", :menu_text => nil, :date => "2013-08-20", :cost => 35.0, :length => 120, :other_info => nil, :host_id => 3, :blurb => "it will be fun!", :time => "2000-01-01 16:00:00")
event = Event.find_or_create_by_title(:title => "Take a Breath", :people_limit => 30, :description => "Tea tasting with Jesse Jacobs, the tea guru behind Samovar", :menu_pdf => "http://www.nen.nl/pdfpreview/preview_68011.pdf", :menu_text => nil, :date => "2013-08-21", :cost => 40.0, :length => 90, :other_info => nil, :host_id => 2, :blurb => "Tea tasting and meditation", :time => "2000-01-01 10:00:00")
event = Event.find_or_create_by_title(:title => "Chronicles of Naan'ia", :people_limit => 30, :description => "Help develop a naan recipe with the founders of Tava", :menu_pdf => "http://www.nen.nl/pdfpreview/preview_68011.pdf", :menu_text => nil, :date => "2013-08-24", :cost => 40.0, :length => 150, :other_info => nil, :host_id => 4, :blurb => "There will be 'naan' left", :time => "2000-01-01 19:00:00")
event = Event.find_or_create_by_title(:title => "All the Fishes in the Sea", :people_limit => 50, :description => "Learn about sustainable seafood over a 4 course lunch near the Bay, all while supporting local fishermen!", :menu_pdf => "http://www.nen.nl/pdfpreview/preview_68011.pdf", :menu_text => nil, :date => "2013-08-27", :cost => 70.0, :length => 180, :other_info => nil, :host_id => 5, :blurb => "Dive into sustainable fishing over lunch", :time => "2000-01-01 12:00:00")
...
image = Image.find_or_create_by_image(:image => 'Food 12.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Event')
image = Image.find_or_create_by_image(:image => 'Food 1.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Event')
image = Image.find_or_create_by_image(:image => 'Food 17.jpg', :title => nil, :description => nil, :imageable_id => 1, :imageable_type => 'Campaign')
image = Image.find_or_create_by_image(:image => 'Food 18.jpg', :title => nil, :description => nil, :imageable_id => 2, :imageable_type => 'Campaign')
image = Image.find_or_create_by_image(:image => 'Food 19.jpg', :title => nil, :description => nil, :imageable_id => 3, :imageable_type => 'Campaign')
image = Image.find_or_create_by_image(:image => 'Food 22.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Campaign')
image = Image.find_or_create_by_image(:image => 'Food 2.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Campaign')
image = Image.find_or_create_by_image(:image => 'Food 23.jpg', :title => nil, :description => nil, :imageable_id => 1, :imageable_type => 'Profile')
image = Image.find_or_create_by_image(:image => 'Food 24.jpg', :title => nil, :description => nil, :imageable_id => 2, :imageable_type => 'Profile')
image = Image.find_or_create_by_image(:image => 'Food 25.jpg', :title => nil, :description => nil, :imageable_id => 3, :imageable_type => 'Profile')
image = Image.find_or_create_by_image(:image => 'Food 26.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Profile')
image = Image.find_or_create_by_image(:image => 'Food 4.jpg', :title => nil, :description => nil, :imageable_id => 4, :imageable_type => 'Profile')
...
profile = Profile.find_or_create_by_user_id(:blurb => "the only thing better than pie or ice cream is pie AND ice cream", :location_id => 1, :story => "We are a sister restaurant of Green Chile Kitchen and started serving the NoPa neighborhood back in 2000.", :home_zip => "94109", :work_zip => "94109", :user_id => 3,  :biz_name => "Chile Pies and Creamery", :yelp_id => nil, :neighborhood => "NoPa")
...
profile = Profile.find_or_create_by_user_id(:blurb => "find peace in the middle of chaos", :location_id => 2, :story => "I became a tea afficianado of tea when I was only 13 and have been all over the world in search of good tea.", :home_zip => "94109", :work_zip => "94107", :user_id => 2, :biz_name => "Samovar Tea Lounge", :yelp_id => nil, :neighborhood => "SoMa")
profile = Profile.find_or_create_by_user_id(:blurb => "ask me about the burroti", :location_id => 3, :story => "One day, four of us left our high paying private equity jobs to, that's right, start a restaurant in South Bay. Now we're up to two! Come check it out :).", :home_zip => "94122", :work_zip => "94109", :user_id => 4, :biz_name => "Tava", :yelp_id => nil, :neighborhood => "SoMa")
profile = Profile.find_or_create_by_user_id(:blurb => "plenty of fish in the sea (and need to keep it that way!)", :location_id => 4, :story => "Fish is the kind of place that once a chef starts woring there and sees how sustainably we cook, he never wants to leave.", :home_zip => "94109", :work_zip => "94109", :user_id => 5, :biz_name => "Fish", :yelp_id => nil, :neighborhood => "Marina")
