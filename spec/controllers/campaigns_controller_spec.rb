...
describe CampaignsController do
  ...
  let(:valid_attributes) { { "bus_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved campaign as @campaign" do
        ...
        post :create, {:campaign => { "bus_name" => "invalid value" }}, valid_session
        assigns(:campaign).should be_a_new(Campaign)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested campaign" do
        ...
        Campaign.any_instance.should_receive(:update_attributes).with({ "bus_name" => "MyString" })
        put :update, {:id => campaign.to_param, :campaign => { "bus_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the campaign as @campaign" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Campaign.any_instance.stub(:save).and_return(false)
        put :update, {:id => campaign.to_param, :campaign => { "bus_name" => "invalid value" }}, valid_session
        assigns(:campaign).should eq(campaign)
      end
